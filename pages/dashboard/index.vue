...
=======
  <div class="flex" :class="{
    ...
    <DashboardContentBookmarksHeader class="flex gap-5 header" v-if="hasBookmarks" v-model:search="search" :hasBookmarks="hasBookmarks" :format="displayFormat" :filterTagsType="filterTagsType" />
>>>>>>> Stashed changes
...
=======
    <div class="inline-flex flex-col items-center gap-5 p-10 text-center border-8 border-dashed no-bookmarks rounded-2xl backdrop-blur-3xl" v-if="useBookmark().bookmarksLoaded && !hasBookmarks">
      <h2 class="text-2xl font-bold">No bookmarks found</h2>
      <p class="text-gray-500">
        You don't have any bookmarks yet. <br />
        Start by adding one dragging and dropping a link, a bookmark from your browser or by dragging and dropping a <a href="/">bookmark file</a>.
...
const displayFormat = computed(
	() => useBookmark().bookmarkDisplayFormat as BookmarkDisplayFormat,
);
