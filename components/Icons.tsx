...
export const Logo = ({ color = "white" }: any) => (
	<svg viewBox="0 0 59 110" xmlns="http://www.w3.org/2000/svg">
		<title>Logo</title>
		<path
			d="M0 5.9C0 2.64152 2.64152 0 5.9 0H53.1C56.3585 0 59 2.64152 59 5.9V20.06C59 20.06 41.3812 28 29.5 28C17.6188 28 0 20.06 0 20.06V5.9Z"
			fill="#3AE000"
		/>
		<path
			d="M0 28.3199C0 28.3199 17.1799 39.5 29.5 39.5C41.8201 39.5 59 28.3199 59 28.3199V89.645C59 98.595 59 103.07 56.0876 104.78C53.1751 106.49 49.2671 104.31 41.4512 99.9499L40.9976 99.6969C35.3784 96.5621 32.5688 94.9947 29.5 94.9947C26.4312 94.9947 23.6216 96.5621 18.0024 99.6969L17.5488 99.9499C9.73287 104.31 5.82489 106.49 2.91244 104.78C0 103.07 0 98.595 0 89.645V28.3199Z"
			fill="#3AE000"
		/>
		<path
			d="M0 22.42C0 22.42 17.6053 30.5 29.5 30.5C41.3947 30.5 59 22.42 59 22.42V25.96C59 25.96 41.8008 37 29.5 37C17.1992 37 0 25.96 0 25.96V22.42Z"
			fill={color}
		/>
	</svg>
);
...
export const NumberedSquare = ({ number = 0, className = "" }: any) => (
	<div
		class={`flex items-center justify-center w-6 h-6 rounded-full border-black border-[1px] p-2${
			className ? ` ${className}` : ""
		}`}
	>
...
export const SearchIcon = () => (
	<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23">
		...
		<path
			fill="#9DA0B8"
			fill-rule="evenodd"
			d="M8.944 2.556a6.389 6.389 0 1 0 0 12.777 6.389 6.389 0 0 0 0-12.777ZM0 8.944a8.944 8.944 0 1 1 16.108 5.357l6.518 6.518a1.278 1.278 0 0 1-1.807 1.807L14.3 16.108A8.944 8.944 0 0 1 0 8.944Z"
			clip-rule="evenodd"
		/>
	</svg>
);
...
export const StarIcon = ({
	color = useTheme().isDarkMode ? "white" : "black",
	fill = "none",
	title = "",
}: any) => (
	<svg
